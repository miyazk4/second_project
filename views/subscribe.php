...
<html lang="pt">
	<head>
		...
		<title>Sabrina Carpenter | Subscribe | Offer</title>
		...
		echo '
				<div class="individual">
					<div class="imageContainer">
						<img src="images/membershipImages/'.$detail["image"].'" alt="">
					</div>
		';

		if($detail["price"] === "0.00") {
			echo '
			...
			echo '
					<div class="price">$'.round($detail["price"]).'</div>
			';
		}

		if($detail["membership_id"] && $detail["membership_id"] !== "3"){
			echo '
					<div class="selectBtn">
						<a href="'.ROOT. 'access/register'.'" class="selectLink">Select</a>
					</div>
			
			';
		}

		else if($detail["membership_id"] === "3"){
			echo '
					<div class="selectBtn">
						<a href="'.ROOT. 'access/register' .'" class="selectLink">Select Size</a>
					</div>
...
<?php
			echo'
				...
				</div> <!-- Fecho da Div class individual -->
		';
	}	
?>
			</div>
