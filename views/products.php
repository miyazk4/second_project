...
<html lang="PT">
	<head>
		...
		<title>Administrative's Area | Sabrina Carpenter</title>
		...
		echo '
			<div class="productOverall">
				<div class="productImage">
					<a href="'. ROOT. 'admin/productDetailAdmin' .'/' . $product["product_id"] .'">
				...
				<div class="details">
					<div>
						<p class="productName">
							<a href="'. ROOT. 'admin/productDetailAdmin' .'/' . $product["product_id"] .'">'.$product["shop_name"].'</a>
						</p>
					</div>
					<div>
						<a href="'. ROOT. 'admin/productDetailAdmin' .'/' . $product["product_id"] .'">$'.$product["price"].'</a>
					</div>
					<div>
						<a href="'. ROOT. 'admin/productDetailAdmin' .'/' . $product["product_id"] .'">Total stock: '.$product["stock"].'</a>
					</div>
					<div>
						<a href="'. ROOT. 'admin/productDetailAdmin' .'/' . $product["product_id"] .'">Size: '.$product["size_id"].'</a>
					</div>
				</div>
			</div>
		';
