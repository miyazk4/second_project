...
<html lang="pt">
	<head>
		...
		<title>Sabrina Carpenter | Discography | <?php echo $detail["name"]; ?></title>
...
if(isset($detail["engineer"])) {
	echo '
		<p>
			<span class="upper">Engineer</span>: '.$detail["engineer"].'
		</p>
	';
...
<?php
	...
	echo '
		<p>
			<span class="upper">Recorded at</span>:'.$detail["recorded_at"].'
		</p>
	';
}
...
?>
						...
						<div>
							<p><span class="upper">Release date</span>: <?php echo strftime("%A, %B %e, %Y", strtotime($detail["release_date"])); ?></p>
						</div>
					</div>
				</div>
